...
export default function ReglementGlobal() {
    ...
    return (
        <div >
            <Header />
            <BgPrincip image={'src/assets/media/img-back/BGLastRP.png'} titre='Règlements Globaux' sousTitre='Ce règlement définit les règles de base du serveur LastRP. Tout joueur doit en prendre connaissance avant de jouer' hSize={'50vh'} />
