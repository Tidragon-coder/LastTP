...
export default function ReglementLegal() {
    ...
    return (
        <div >
            <Header />
            <BgPrincip image={'src/assets/media/img-back/BGLastRP.png'} titre='Règlements Légal' sousTitre='Ce règlement définit les règles de base du serveur LastRP. Tout joueur doit en prendre connaissance avant de jouer' hSize={'50vh'} />
